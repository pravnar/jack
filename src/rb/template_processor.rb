...
EOF
  ...
  CLOJURE_MODEL_TEMPLATE = load_template("clojure_templates/model.erb")
  ...
  def self.process_database_defn(project_defn, database_defn, output_dir, model_defns, by_table_name)
    ...
    FileUtils.mkdir_p("#{output_dir}/clj/")
    ...
    model_defns.each do |model_defn|
      ...
      file = File.new("#{output_dir}/clj/#{model_defn.model_name}.clj", "w")
      file.puts(CLOJURE_MODEL_TEMPLATE.result(binding))
      file.close
